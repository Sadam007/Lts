...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2019 at 08:26 PM
...
(183, '25', 1998, 0, 0),
(184, '057', 243, 0, 3),
(185, 'uom/7777', 244, 0, 10),
(186, 'jfskfja', 245, 0, 2),
(187, 'this is testing project', 246, 0, 2),
(188, 'this is testing projectfjdskjf', 247, 0, 2);
...
(244, '03/09/19 10:51:12', 'Hello there ', 'Rahat Ullah', 'rahat@yahoo.com', 'uom/7777', '10', 'afnankhan@yahoo.com', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex impedit eveniet placeat corrupti non modi molestias eaque aliquid accusantium. Cum molestiae exercitationem numquam accusantium natus illum atque rem unde nam.', 'pending', '', '59988-kashmir.jpg', 0),
(245, '03/09/19 10:52:49', 'this is testing project', 'Rahat Ullah', 'rahat@yahoo.com', 'jfskfja', '2', 'sadam.uom7@gmail.com', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex impedit eveniet placeat corrupti non modi molestias eaque aliquid accusantium. Cum molestiae exercitationem numquam accusantium natus illum atque rem unde nam.', 'final', '', '19637-Capture7.JPG', 0),
(246, '03/09/19 10:55:10', 'forwared to another user', 'Sadam Khan', 'sadam.uom7@gmail.com', 'this is testing project', '2', 'sadam.uom7@gmail.com', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex impedit eveniet placeat corrupti non modi molestias eaque aliquid accusantium. Cum molestiae exercitationem numquam accusantium natus illum atque rem unde nam.', 'pending', '', '11410-EAv64GTW4AARkdB.jfif', 0),
(247, '03/09/19 10:57:19', 'forwared to another user', 'Rahat Ullah', 'rahat@yahoo.com', 'this is testing projectfjdskjf', '2', 'sadam.uom7@gmail.com', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex impedit eveniet placeat corrupti non modi molestias eaque aliquid accusantium. Cum molestiae exercitationem numquam accusantium natus illum atque rem unde nam.', 'received', '', '57246-Simmons_OneView_How_to_Interpret_Crosstab_Data.pdf', 0),
(248, '03/09/19 11:17:58', 'forwared to another user', 'Sadam Khan', 'sadam.uom7@gmail.com', 'this is testing projectfjdskjf', '4', 'test@khan.xom', '\r\n			', 'final', '', '57246-Simmons_OneView_How_to_Interpret_Crosstab_Data.pdf', 0),
(249, '03/09/19 11:19:41', 'forwared to another user', 'Sadam Khan', 'sadam.uom7@gmail.com', 'this is testing projectfjdskjf', '4', 'test@khan.xom', '\r\n			', 'received', '', '57246-Simmons_OneView_How_to_Interpret_Crosstab_Data.pdf', 0),
(250, '03/09/19 11:19:46', 'forwared to another user', 'Sadam Khan', 'sadam.uom7@gmail.com', 'this is testing projectfjdskjf', '4', 'test@khan.xom', '\r\n			', 'pending', '', '57246-Simmons_OneView_How_to_Interpret_Crosstab_Data.pdf', 0),
(251, '03/09/19 11:20:09', 'forwared to another user', 'Sadam Khan', 'sadam.uom7@gmail.com', 'this is testing projectfjdskjf', '4', 'test@khan.xom', 'hello there', 'pending', '', '57246-Simmons_OneView_How_to_Interpret_Crosstab_Data.pdf', 0),
(252, '03/09/19 11:21:42', 'forwared to another user', 'testing khan', 'test@khan.xom', 'this is testing project', '4', 'test@khan.xom', '\r\n			', 'pending', '', '11410-EAv64GTW4AARkdB.jfif', 0),
(253, '03/09/19 11:22:27', 'forwared to another user', 'testing khan', 'test@khan.xom', 'testing project', '6', 'saeed@gmail.com', '\r\n			', 'pending', '', '', 0),
(254, '03/09/19 11:22:54', 'forwared to another user', 'testing khan', 'test@khan.xom', 'testing project', '6', 'saeed@gmail.com', '\r\n			', 'pending', '', '', 0),
(255, '03/09/19 11:23:02', 'forwared to another user', 'testing khan', 'test@khan.xom', 'testing project', '6', 'saeed@gmail.com', '\r\n			', 'pending', '', '', 0),
(256, '03/09/19 11:23:20', 'forwared to another user', 'testing khan', 'test@khan.xom', 'this is testing projectfjdskjf', '9', 'shahid@yahoo.com', '\r\n			', 'pending', '', '57246-Simmons_OneView_How_to_Interpret_Crosstab_Data.pdf', 0);
...
(88, 'Sadam Khan', 'sadam.uom7@gmail.com', '63d6f9e05f8afd44bf42935afdb99d6d', '2', 'Teacher'),
(89, 'Rahat Ullah', 'rahat@yahoo.com', 'a80b693d7e23f1153de77a680d883b59', '3', 'Teacher'),
(90, 'testing khan', 'test@khan.xom', 'a80b693d7e23f1153de77a680d883b59', '4', 'teacher');
...
--
ALTER TABLE `letterstatus`
  MODIFY `LStatusId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;

--
-- AUTO_INCREMENT for table `letter_status`
--
ALTER TABLE `letter_status`
  MODIFY `id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=257;
...
--
ALTER TABLE `user`
  MODIFY `id` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
COMMIT;
